...
# $Header: /var/cvsroot/gentoo-x86/media-libs/mesa/mesa-7.4.4.ebuild,v 1.2 2009/09/21 10:41:36 scarabeus Exp $
...
IUSE="${IUSE_VIDEO_CARDS} ${IUSE_UNSTABLE}
	debug motif nptl pic hardened xcb kernel_FreeBSD"
