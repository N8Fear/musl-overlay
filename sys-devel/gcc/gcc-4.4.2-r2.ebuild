...
# $Header: /var/cvsroot/gentoo-x86/sys-devel/gcc/gcc-4.4.2-r1.ebuild,v 1.2 2009/10/18 01:26:00 Zorry Exp $
...
# bug #78951 and profile support to get sparc* support on hardened.
